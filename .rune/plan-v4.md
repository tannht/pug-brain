...
| 2 | Adaptive Depth v2 | ⬚ Pending | plan-v4-phase2.md | Calibration → depth tuning, session-aware |
| 3 | Predictive Priming | ⬚ Pending | plan-v4-phase3.md | Pre-warm memories from session context |
